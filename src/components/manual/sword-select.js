...
const listOfWeapons = {
    ...
    "Cleaver" : new Sword(40,10,0,0,0,0,0,0,0,{},listOfSwordPassives["Cleaver Passive"],"Uncommon"),
...
class SwordSelect extends React.Component {
    constructor() {
        ...
        this.handleRecombobulatorChange = this.handleRecombobulatorChange.bind(this);
    }
